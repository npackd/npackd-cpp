...
cmake ..\ -G "MinGW Makefiles" -DCMAKE_BUILD_TYPE=MinSizeRel -DNPACKED_FORCE_STATIC_QT:BOOL=ON -DNPACKED_BUILD_CLU:BOOL=OFF -DNPACKED_BUILD_NPACKDCL:BOOL=OFF -DNPACKED_BUILD_NPACKDG:BOOL=ON -DNPACKD_BUILD_TESTS:BOOL=OFF -DCMAKE_INSTALL_PREFIX=..\install
if %errorlevel% neq 0 exit /b %errorlevel%
...
cmake ..\ -G "MinGW Makefiles" -DCMAKE_BUILD_TYPE=MinSizeRel -DNPACKED_FORCE_STATIC_QT:BOOL=ON -DNPACKED_BUILD_CLU:BOOL=OFF -DNPACKED_BUILD_NPACKDCL:BOOL=ON -DNPACKED_BUILD_NPACKDG:BOOL=OFF -DNPACKD_BUILD_TESTS:BOOL=OFF -DCMAKE_INSTALL_PREFIX=..\install
if %errorlevel% neq 0 exit /b %errorlevel%
...
cmake ..\ -G "MinGW Makefiles" -DCMAKE_INSTALL_PREFIX=..\install -DNPACKED_FORCE_STATIC_QT:BOOL=ON -DNPACKED_BUILD_CLU:BOOL=ON -DNPACKED_BUILD_NPACKDCL:BOOL=OFF -DNPACKED_BUILD_NPACKDG:BOOL=OFF -DNPACKD_BUILD_TESTS:BOOL=OFF "-DZLIB_ROOT:PATH=%zlib%"
if %errorlevel% neq 0 exit /b %errorlevel%
