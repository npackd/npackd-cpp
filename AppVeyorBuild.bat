...
cd npackdcl\build&&set path=%mingw%\bin;C:\Program Files (x86)\CMake\bin&&set zlib_root=%qt%\qtbase\src\3rdparty\zlib&&cmake ..\ -G "MinGW Makefiles" -DCMAKE_INSTALL_PREFIX=%cd%\npackdcl\install"
if %errorlevel% neq 0 exit /b %errorlevel%
