...
C:\msys64\usr\bin\pacman -S --noconfirm mingw-w64-i686-ninja mingw-w64-i686-toolchain mingw-w64-i686-libtool mingw32/mingw-w64-i686-jasper mingw32/mingw-w64-i686-qt5-static mingw32/mingw-w64-i686-icu mingw32/mingw-w64-i686-zstd
if %errorlevel% neq 0 exit /b %errorlevel%
...
C:\msys64\usr\bin\pacman -S --noconfirm mingw-w64-x86_64-ninja mingw-w64-x86_64-toolchain mingw-w64-x86_64-libtool mingw64/mingw-w64-x86_64-jasper mingw64/mingw-w64-x86_64-qt5 mingw64/mingw-w64-x86_64-icu mingw64/mingw-w64-x86_64-zstd mingw64/mingw-w64-x86_64-quazip
if %errorlevel% neq 0 exit /b %errorlevel%
