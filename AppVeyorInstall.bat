...
C:\msys64\usr\bin\pacman -S --noconfirm base-devel mingw-w64-i686-libtool mingw32/mingw-w64-i686-jasper mingw32/mingw-w64-i686-qt5-static
if %errorlevel% neq 0 exit /b %errorlevel%
...
:bits64
C:\msys64\usr\bin\pacman -S --noconfirm base-devel mingw-w64-x86_64-libtool  mingw64/mingw-w64-x86_64-jasper mingw64/mingw-w64-x86_64-qt5-static
if %errorlevel% neq 0 exit /b %errorlevel%
