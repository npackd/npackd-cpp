...
C:\msys64\usr\bin\pacman -S --noconfirm mingw-w64-i686-ninja mingw-w64-i686-libtool mingw32/mingw-w64-i686-jasper mingw32/mingw-w64-i686-qt5-static mingw32/mingw-w64-i686-icu mingw32/mingw-w64-i686-zstd
if %errorlevel% neq 0 exit /b %errorlevel%
